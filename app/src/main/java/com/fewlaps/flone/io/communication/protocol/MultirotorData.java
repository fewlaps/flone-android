...
public abstract class MultirotorData {
    ...
    public void Connect(String address, int speed, int startDelay) {
        stopThreads();
...
//			}
            ...
            synchronized (MultirotorData.this) {
                mConnectThread = null;
            }
            if (stop) {
                return;
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(Communication connection) {
